...
const ALLOWED_TABLES = new Set([
  'partners','partner_taps','guest_shares','members','board_notes','notifications','huddle_messages','help_requests','coach_touchpoints','portal_messages','exercise_videos',
...
Allergies: ${mp.allergies||'none'}. Medical conditions: ${mp.conditions||'none'}.`;
      ...
      if (url.pathname === '/reports/aggregate' && request.method === 'POST') {
        ...
        const binds = [from, to];
        if (b.gym_id && b.source !== 'guest_shares') { q += ' AND gym_id = ?'; binds.push(b.gym_id); }
