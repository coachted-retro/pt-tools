...
CREATE TABLE challenges (id INTEGER PRIMARY KEY AUTOINCREMENT, month TEXT, title TEXT, description TEXT, active INTEGER DEFAULT 1, created_at TEXT DEFAULT (datetime('now')));
...
CREATE TABLE daily_content (id INTEGER PRIMARY KEY AUTOINCREMENT, content_date TEXT, content TEXT, created_at TEXT DEFAULT (datetime('now')));
