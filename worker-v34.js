...
const ALLOWED_TABLES = new Set([
  ...
  'staff_availability','time_off_requests','gym_events','churn_surveys','chef_recipes','pt_appointments','coach_daily_tips','saved_programs','coach_coverage','group_classes','group_class_sessions','marketing_media','followups','eod_flag_dismissals','cardio_logs','pt_leads'
]);
